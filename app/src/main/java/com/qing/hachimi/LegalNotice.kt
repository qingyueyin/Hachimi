...
object LegalNotice {
    ...
    const val INTRO = "本软件是网易云音乐的辅助下载工具，不是破解软件，不提供会员音质破解或免费获取付费内容的功能。与网易云音乐及其关联公司无任何合作或授权关系。请在继续使用前完整阅读下列条款。"

    val CLAUSES: List<Pair<String, String>> = listOf(
        "非破解软件" to "本软件不是破解工具，不提供任何会员音质破解、绕过付费或免费获取付费内容的功能。所有音质权限由网易云音乐账号等级决定，本软件仅作为下载工具使用。",
